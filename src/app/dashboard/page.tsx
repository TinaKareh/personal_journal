...
const Dashboard = () => {
  ...
  const filteredEntries = entries.filter((entry) =>
    selectedLabel
      ? entry.title.toLowerCase().includes(selectedLabel.toLowerCase())
      : true
  );
  ...
  return (
    <div className="bg-[#0E0F1C] text-white min-h-screen p-30">
      ...
      <section className="flex justify-center mb-8 gap-4">
        <button
          className={`px-4 py-2 rounded-md text-white font-semibold border-2 ${
            selectedLabel === "Work"
              ? "bg-blue-600 border-blue-600"
              : "bg-[#22242b] border-transparent hover:bg-blue-500 hover:border-blue-500"
          } `}
        ...
        <button
          className={`px-4 py-2 rounded-md text-white font-semibold border-2 ${
            selectedLabel === "Relationships"
              ? "bg-green-600 border-green-600"
              : "bg-[#22242b] border-transparent hover:bg-green-500 hover:border-green-500"
          } `}
        ...
        <button
          className={`px-4 py-2 rounded-md text-white font-semibold border-2 ${
            selectedLabel === "Addiction"
              ? "bg-purple-600 border-purple-600"
              : "bg-[#22242b] border-transparent hover:bg-purple-500 hover:border-purple-500"
          } `}
        ...
        <button
          className={`px-4 py-2 rounded-md text-white font-semibold border-2 ${
            selectedLabel === "Reading"
              ...
              : "bg-[#22242b] border-transparent hover:bg-yellow-500 hover:border-yellow-500"
          } `}
